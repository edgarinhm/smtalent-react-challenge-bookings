        ...
        <div className="mt-6 mb-4 p-1 flex items-center relative bg-yellow-500 rounded-lg max-w-full">
          <div className="flex flex-auto bg-white rounded-md w-1/3">
            <div className="p-2 w-full">
              <Input className="mt-0.5 mb-0.5 p-1 border-solid border border-transparent rounded w-full outline-transparent" />
            </div>
          </div>
          ...
          <div className="flex flex-auto ml-1 rounded bg-yellow-500">
            <Button className="w-full rounded bg-blue-600 p-4 text-sm/6 font-semibold text-white shadow-inner shadow-white/10 focus:outline-none data-[hover]:bg-blue-700 data-[open]:bg-blue-700 data-[focus]:outline-1 data-[focus]:outline-white">
              {'Buscar'}
            </Button>
          </div>
        </div>
